package com.jeethink.process.definition.service;
...
//        runtimeService.startProcessInstanceByKey("oneTaskProcess");
     ...
     * @return
     */
    public Page<com.jeethink.process.definition.domain.ProcessDefinition> listProcessDefinition(com.jeethink.process.definition.domain.ProcessDefinition processDefinition) {
        PageDomain pageDomain = TableSupport.buildPageRequest();
        Integer pageNum = pageDomain.getPageNum();
        Integer pageSize = pageDomain.getPageSize();

        Page<com.jeethink.process.definition.domain.ProcessDefinition> list = new Page<>();
        ...
        for (ProcessDefinition definition: processDefinitionList) {
            com.jeethink.process.definition.domain.ProcessDefinition entity = new com.jeethink.process.definition.domain.ProcessDefinition();
