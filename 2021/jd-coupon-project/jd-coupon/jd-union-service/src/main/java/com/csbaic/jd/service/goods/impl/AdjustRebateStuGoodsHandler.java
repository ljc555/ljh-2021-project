 ...
 * 根据用户的身份调整用户返利金额
 */
class AdjustRebateStuGoodsHandler extends AbstractUserGoodsHandler<StuGoods>
{



    AdjustRebateStuGoodsHandler(IUserService userService) {
        super(userService);
    }
    ...
    @Override
    protected void handleImpl(UserEntity userEntity, StuGoods metadata) {
