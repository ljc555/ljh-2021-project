const app = getApp()
const {productDetails, goodsUrl, productsCode, appCode} = require("../../utils/network/services/productImpl.js")
    ...
    onLoad: function (options) {
        ...
        if(options.scene){
            ...
            util.setStorage(constants.INVITE_DATA, {
                type: constants.INVITE_SHARE_APPS,
                sukId: this.data.scene.id,
        ...
        let data = util.getStorage(constants.INVITE_DATA)
        wx.login({
            success: res => {
                onLogin(res.code)
                    .then(res => {
                        ...
                        productDetails(data.sukId).then(res => {
